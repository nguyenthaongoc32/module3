...
const NewTeacher = () => {
    ...
    useEffect(() => {
        ...
        const fetchPositions = async () => {
            try {
                const response = await axios.get('http://localhost:8080/api/teachers/getPosition');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8080/api/teachers/postTeacher', {
                ...teacher,
