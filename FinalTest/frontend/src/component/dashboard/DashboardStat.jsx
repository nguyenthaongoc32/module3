    ...
    <Card classNames="px-4 py-5 sm:p-6" style={{ backgroundColor: "#fff" }}>
      <div className="flex items-center justify-between">
        <div>
          ...
          <h3 className="text-brand-primary-black font-semibold text-[1.875rem] mt-3">
        ...
        <p className="flex items-center gap-2 text-[.8125rem]">
          <span
            className={`flex items-center gap-2 ${
              stat.growth.name === "progress" ? "text-[#00B69B]" : "text-[#F93C65]"
            }`}
          >
          ...
          <span className="text-[#606060]">
            {stat.growth.name === "progress" ? "Up" : "Down"} from {stat.growth.time}
          </span>
        </p>
      </div>
    </Card>
